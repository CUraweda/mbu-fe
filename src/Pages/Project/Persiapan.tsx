...
const Persiapan: React.FC = () => {
  ...
  const columns = [
    ...
    { header: "Aktual Waktu Persiapan (hari)", accessorKey: "hari" },
  ...
  const handleEditClick = (type: number, item: Item) => {
    switch (type) {
      ...
      case 2:
        ...
        break;
      case 3:
        navigate(`/persiapan/lanjutan/${item.id}`, {
          state: { projectData: item },
        });
        break;
      case 4:
        navigate(`/persiapan/approval/${item.id}`, {
                          ...
                          <div className="relative z-40 dropdown dropdown-left">
                            ...
                            >
                              ...
                              <li onClick={() => handleEditClick(3, item)}>
                                <a>Persiapan Lanjutan</a>
                              </li>
                              <li onClick={() => handleEditClick(4, item)}>
                                <a>Approval Persiapan Lanjutan</a>
                              </li>
                            </ul>
                          </div>
                        </div>
